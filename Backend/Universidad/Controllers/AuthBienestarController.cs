...
{
    [ApiController]
    [Route("api/bienestar/auth")]
    public class AuthBienestarController : ControllerBase
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly AppDbContext _context;
        
        public AuthBienestarController(IHttpClientFactory httpClientFactory, AppDbContext context)
        {
        ...
        {
            var ClientId = "1466593430628204756";
            var redirectUri = "http://localhost:5024/api/bienestar/auth/callback";
        ...
        public async Task<IActionResult> Callback([FromQuery] string code)
        {
            ...
            var ClientId = "1466593430628204756";
            var ClientSecret = "fxxggHsceTsRPXmVm0vBAon0uf3OcINr";
            var redirectUri = "http://localhost:5024/api/bienestar/auth/callback";
